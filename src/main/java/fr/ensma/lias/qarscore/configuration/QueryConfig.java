...
public class QueryConfig {
    ...
    // List of super class
    public static String LIST_SUPER_CLASSES = RDF_PREFIX
	    + "SELECT ?directsuperclasses ?classe "
	    + "WHERE { ?classe rdfs:subClassOf ?directsuperclasses " 
	    + "FILTER(?directsuperclasses != ?classe && isIRI(?classe) && isIRI(?directsuperclasses)) "
	    + "OPTIONAL { "
	    + "?classe rdfs:subClassOf ?othersuperclasse ."
	    + "?othersuperclasse rdfs:subClassOf ?directsuperclasses ."
    ...
    public static String LIST_SUPER_PROPERTIES = RDF_PREFIX
	    + "SELECT ?directsuperproperty ?property "
	    ...
	    + "OPTIONAL { "
	    + "?property rdfs:subPropertyOf ?othersuperproperty ."
    ...
    public static String NUMBER_TRIPLET = RDF_PREFIX
	    + "SELECT (COUNT(*) AS ?numberTriplet) " + "WHERE { ?s ?p ?o "
	    + " }";
    ...
    public static String LIST_CLASS = RDF_PREFIX + "SELECT DISTINCT ?classe "
	    + "WHERE { ?instance rdf:type ?classe " + "}";
