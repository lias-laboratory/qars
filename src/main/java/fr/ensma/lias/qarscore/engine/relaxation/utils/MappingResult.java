...
public class MappingResult {
	...
	/**
	 * Entry of the result value in dictionary for each variable 0 if variable has a
	 * null value for the specify mapping
	 */
	 ...
	 * second mapping otherMapping. If the two mappings are'nt compatibles return
	 * null.
	 * 
	 * @param otherMapping
	 * @return
