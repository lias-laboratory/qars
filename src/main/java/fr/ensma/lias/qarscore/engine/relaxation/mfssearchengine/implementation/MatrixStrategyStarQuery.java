...
public class MatrixStrategyStarQuery extends MatrixStrategy {
	 ...
	 */
	protected MatrixStrategyStarQuery(Session s, CQuery conjunctiveQuery, int expected_answers_number) {

		super(s, conjunctiveQuery, expected_answers_number);

		SESSION = s;
		CURRENT_CONJUNCTIVE_QUERY = conjunctiveQuery;
		values = new RoaringBitmap[CURRENT_CONJUNCTIVE_QUERY.getElementList().size() + 1];
