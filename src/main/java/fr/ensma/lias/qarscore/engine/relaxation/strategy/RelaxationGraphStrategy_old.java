 ...
 * @author Geraud FOKOU
 */
public class RelaxationGraphStrategy_old {
     ...
     */
    public RelaxationGraphStrategy_old(Session s) {
	...
	nbSolution = session.createStatement(query.toString()).getResultSetSize();
	return nbSolution;
    }
