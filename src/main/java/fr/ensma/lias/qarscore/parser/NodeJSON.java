...
public class NodeJSON {
	...
	public NodeJSON(String name, String namespace, String prefixLabel, String iri, String label) {
		nodeName = name;
	...
	public String toString() {
		...
		String node = "{\"label\" : \"" + this.nodeLabel + "\"," + " \"uri\":\"" + this.getNodeIRI()
				+ "\", \"prefix\":\"" + this.getNodeNameSpaceLabel() + "\", \"prefixValue\":\""
	...
	private String attributeToString() {
		...
		String attrib = "[{\"name\" : \"" + attributesNames.get(0) + "\", \"type\" : \"" + attributesType.get(0)
				+ "\", \"uri\":\"" + attributesURI.get(0) + "\", \"prefix\":\"" + this.getNodeNameSpaceLabel()
				+ "\", \"prefixValue\":\"" + this.getNodeNameSpace() + "\"}";

		for (int i = 1; i < attributesNames.size() - 1; i++) {
			attrib = attrib + ", {\"name\" : \"" + attributesNames.get(i) + "\", \"type\" : \"" + attributesType.get(i)
					+ "\", \"uri\":\"" + attributesURI.get(i) + "\", \"prefix\":\"" + this.getNodeNameSpaceLabel()
					+ "\", \"prefixValue\":\"" + this.getNodeNameSpace() + "\"}";
		}

		attrib = attrib + ", {\"name\" : \"" + attributesNames.get(attributesNames.size() - 1) + "\", \"type\" : \""
				+ attributesType.get(attributesNames.size() - 1) + "\", \"uri\":\""
				+ attributesURI.get(attributesNames.size() - 1) + "\", \"prefix\":\"" + this.getNodeNameSpaceLabel()
				+ "\", \"prefixValue\":\"" + this.getNodeNameSpace() + "\"}]";
