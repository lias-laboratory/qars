...
import fr.ensma.lias.qarscore.connection.implementation.JenaSession_Old;
import fr.ensma.lias.qarscore.connection.statement.ModelStatement;

/**
 * @author Geraud FOKOU
 */
public class JenaModelStatement_old implements ModelStatement {

    /**
     * Session of the current model statement
     */
    JenaSession_Old session = null;

    /**
     * Constructor
     */
    public JenaModelStatement_old(Session s) {
	session = (JenaSession_Old) s;
    }
