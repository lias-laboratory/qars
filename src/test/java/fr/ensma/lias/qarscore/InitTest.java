...
//    public final static String TDB_PATH_SAT= "c:/TDB/UBA_saturated";
	public final static String TDB_ALIAS = "tdb750";
	...
	/**
	 * @throws java.lang.Exception For sesame: sessionSesame =
	 *                             SessionFactory.getNativeSesameSession(repository_path);
	 */
	@Before
	public void setUp() {
...
//	session = SessionFactory.getEndpointSession(LUBM_SATURATED_FUSEKI);
	...
	/**
	 * @throws java.lang.Exception For Sesame: sessionSesame.close();
	 */
	@After
