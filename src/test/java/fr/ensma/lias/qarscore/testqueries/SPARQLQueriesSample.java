...
public class SPARQLQueriesSample {
    ...
    public static String QUERY_2 = LUBM_PREFIX
	    + "SELECT ?P ?Y1 ?Y2 ?Y3 ?Y4 "
	    + "WHERE {?X ub:publicationAuthor ?Y1 . "
	    + "?Y1 ub:advisor ?Y2 . "
	    + "?Y2 ub:worksFor ?Y3 . "
	    + "?Y3 ub:subOrganizationOf ?Y4 . "
	    + "?Y4 ub:teacherOf <http://www.Department0.University0.edu/Course1> . "
	    + "}";

    // 7 triple patterns Star
    public static String QUERY_3 = LUBM_PREFIX
	    + "SELECT ?X ?Y1 ?Y2 ?Y3 ?Y4 "
	    + "WHERE { ?X ub:undergraduateDegreeFrom <http://www.University303.edu> . "
	    + "?X rdf:type ub:GraduateStudent ."
	    + "?X ub:takesCourse <http://www.Department0.University0.edu/GraduateCourse0>.  "
	    + "?X ub:name ?Y1 . " + "?X ub:telephone ?Y2 . "
	    + "?X ub:memberOf ?Y3 . " + "?X ub:advisor ?Y4 " + "}";

    // 9 triple patterns Composite
    public static String QUERY_4 = LUBM_PREFIX
	    + "SELECT ?X ?Y1 ?Y2 ?Y3 ?Y4 ?Y5 ?Y6 ?Y7 "
	    + "WHERE { ?X rdf:type ub:FullProfessor . "
	    + "?X ub:doctoralDegreeFrom <http://www.University8.edu> . "
	    + "?X ub:researchInterest 'Research23' . " + "?X ub:name ?Y1 . "
	    + "?X ub:teacherOf ?Y4 . " + "?Y5 ub:takesCourse ?Y4 . "
	    + "?Y5 ub:name ?Y6 . " + "?Y5 ub:advisor ?Y7 . "
	    + "?Y7 ub:worksFor <http://www.Department0.University0.edu> . "
	    + "}";

    // 11 triple patterns Star
    public static String QUERY_5 = LUBM_PREFIX
	    ...
	    + "?X ub:mastersDegreeFrom ?Y5 . "
	    + "?X ub:doctoralDegreeFrom ?Y6 . " + "?X ub:worksFor ?Y7 . "
    ...
    public static String QUERY_6 = LUBM_PREFIX
	    ...
	    + "?X ub:mastersDegreeFrom ?Y5 . "
	    + "?X ub:doctoralDegreeFrom ?Y6 . "
	    + "?X ub:headOf ?Y7 . "
	    + "?X ub:worksFor ?Y8 . "
	    + "?Y8 ub:subOrganizationOf <http://www.University8.edu> . "
    ...
    public static String QUERY_7 = LUBM_PREFIX
	    + "SELECT ?X ?Y1 ?Y2 ?Y3 ?Y4 ?Y7 ?Y8 ?Y9 ?Y10 ?Y11 "
	    ...
	    + "?X ub:age ?Y5 . "
	    + "?X ub:advisor ?Y6 ."
	    + "?X ub:teachingAssistantOf <http://www.Department0.University0.edu/Course1> . "
	    + "?X ub:teachingAssistantOf ?Y7 . "
	    + "?X ub:researchInterest ?Y8 . "
	    + "?X ub:researchInterest 'Research2' . " + " }";

    // 15 triple patterns Composite
    public static String QUERY_8 = LUBM_PREFIX
	    + "SELECT ?X ?Y1 ?Y2 ?Y3 ?Y4 ?Y5 ?Y6 ?Y7 ?Y8 ?Y9 ?Y10 ?Y11 "
	    + "WHERE { ?X rdf:type ub:FullProfessor . "
	    + "?X ub:doctoralDegreeFrom <http://www.University8.edu> . "
	    + "?X ub:researchInterest 'Research23' . " + "?X ub:name ?Y1 . "
	    + "?X ub:emailAddress ?Y2 . " + "?X ub:telephone ?Y3 . "
	    + "?X ub:undergraduateDegreeFrom ?Y4 . "
	    + "?X ub:mastersDegreeFrom ?Y5 . " + "?X ub:teacherOf ?Y6 . "
	    + "?Y7 ub:takesCourse ?Y6 . " + "?Y7 ub:name ?Y8 . "
	    + "?Y7 ub:telephone ?Y9 . " + "?Y7 ub:memberOf ?Y10 . "
	    + "?Y7 ub:advisor ?Y11 . "
	    + "?Y11 ub:worksFor <http://www.Department0.University0.edu> . "
	    + "}";

    // 12 triple patterns Star
    public static String QUERY_9 = LUBM_PREFIX
	    + "SELECT ?X ?Y1 ?Y2 ?Y3 ?Y4 ?Y5 ?Y6 ?Y7 ?Y8 ?Y9 "
	    + "WHERE { ?X rdf:type ub:VisitingProfessor . "
	    + "?X ub:memberOf <http://www.Department1.University1.edu> . "
	    + "?X ub:teacherOf <http://www.Department0.University0.edu/Course1> . "
	    + "?X ub:name ?Y1 . "
	    + "?X ub:emailAddress ?Y2 . "
	    + "?X ub:telephone ?Y3 . "
	    + "?X ub:undergraduateDegreeFrom <http://www.Department0.University0.edu> . "
    ...
    public static String QUERY_10 = LUBM_PREFIX
	    ...
	    + "?X ub:emailAddress ?Y2 . " + "?X ub:telephone ?Y3 . "
	    + "?X ub:teacherOf ?Y4 . " + "?Y5 ub:takesCourse ?Y4 . "
	    + "?Y5 ub:name ?Y6 . " + "?Y5 ub:telephone ?Y7 . "
	    + "?Y5 ub:memberOf ?Y8 . " + "?Y5 ub:advisor ?Y9 . "
	    + "?Y9 ub:worksFor <http://www.Department0.University0.edu> . "
	    + "}";

    // 15 triple patterns Star
    public static String QUERY_13 = LUBM_PREFIX
	    + "SELECT ?X ?Y1 ?Y2 ?Y3 ?Y4 ?Y7 ?Y8 ?Y9 ?Y10 ?Y11 "
	    + "WHERE { ?X rdf:type ub:VisitingProfessor . "
	    + "?X ub:memberOf <http://www.Department1.University1.edu> . "
	    + "?X ub:teacherOf <http://www.Department0.University0.edu/Course1> . "
...
//	    + "?X ?P2 ?R2 . " 
    ...
    public static String QUERY_17 = LUBM_PREFIX
	    + "SELECT ?X  "
    ...
    public static String QUERY_18 = LUBM_PREFIX + "SELECT ?X ?Z " + "WHERE { "
	    + "{?X rdf:type ub:FullProfessor . "
	    + "?X ub:publicationAuthor ?Y . " + "?X ub:age ?age . "
	    + "Filter ((?age<60) && (?age>50))}"
    ...
    // 12 triples
    public static String EDBT_QUERY_4 = LUBM_PREFIX
	    + "SELECT ?X ?Y1 ?Y2 ?Y3 ?Y4 ?Y5 ?Y6 ?Y7 ?Y8 ?Y9 "
    ...
    public static String CONSTRUCT_QUERY_2 = LUBM_PREFIX
	    + "CONSTRUCT  {}"
	    + "WHERE {}";
