...
public class IncrementalMFSBaseRelaxationStrategyTest extends InitTest {
	...
	public void testRelaxationWithFullMFSStrategy() {
		...
		CQuery conjunctiveQuery = CQueryFactory.createCQuery(SPARQLQueriesSample.WWW_QUERY_5);

		long begin = System.currentTimeMillis();
		RelaxationStrategy relaxed_query = new IncrementalMFSBaseRelaxationStrategy(conjunctiveQuery, session);
