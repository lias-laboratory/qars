...
public class BasicRelaxationStrategyTest extends InitTest {
	...
	public void testRelaxationWithHuangStrategy() {
		...
		CQuery conjunctiveQuery = CQueryFactory.createCQuery(SPARQLQueriesSample.WWW_QUERY_3);

		long begin = System.currentTimeMillis();
		RelaxationStrategy relaxed_query = new BasicRelaxationStrategy(conjunctiveQuery, session);
