 ...
 * @author Geraud FOKOU
 */
public class LatticeStrategyWithIndexTest extends InitTest {
	...
	public void testGetOneMFS() {
		...
		relaxationStrategy = StrategyFactory.getLatticeStrategy(session, conjunctiveQuery, true);
	...
	public void testGetAllMFS() {
		CQuery conjunctiveQuery = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_7);
		...
		Assert.assertEquals(15, allCauses.size());
		...
		Assert.assertEquals(3, allSuccess.size());
