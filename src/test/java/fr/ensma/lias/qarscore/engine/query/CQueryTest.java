...
public class CQueryTest {
	...
	public void testGetElementList() {
		...
		CQuery conjunctiveQuery = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_13);
		...
		for (CElement elt : conjunctiveQuery.getElementList()) {
			...
			logger.info(((ElementPathBlock) elt.getElement()).getPattern().toString());
		}

		conjunctiveQuery = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_18);
	...
	public void testGetSelectedQueryVarNames() {
		...
		CQuery conjunctiveQuery = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_18);
	...
	public void testIsStarQuery() {
		...
		conjunctiveQuery = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_10);
		Assert.assertTrue(conjunctiveQuery.isValidQuery());
		Assert.assertTrue(!conjunctiveQuery.isStarQuery());
		for (CElement elt : conjunctiveQuery.getElementList()) {
			if (elt.getElement() instanceof ElementPathBlock) {
	...
	public void testIsSubQueryOf() {
		CQuery conjunctiveQuery21 = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_21);
		Assert.assertTrue(conjunctiveQuery21.isValidQuery());
		CQuery conjunctiveQuery19 = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_19);
		...
		CQuery conjunctiveQuery20 = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_20);
	...
	public void testReplace() {
		CQuery conjunctiveQuery10 = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_10);
		Assert.assertTrue(conjunctiveQuery10.isValidQuery());
		CQuery conjunctiveQuery9 = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_9);
		...
		conjunctiveQuery9.replace(element1.getPattern().getList().get(0).getObject(),
				element.getPattern().getList().get(0).getObject());
	...
	public void testEqualsObject() {
		CQuery conjunctiveQuery14 = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_14);
		Assert.assertTrue(conjunctiveQuery14.isValidQuery());

		CQuery conjunctiveQuery14bis = CQueryFactory.createCQuery(SPARQLQueriesSample.QUERY_14);
		...
		conjunctiveQuery14bis.replace(element.getPattern().getList().get(0).getObject(),
				element1.getPattern().getList().get(0).getObject());
