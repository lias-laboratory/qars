 ...
 * @author Geraud FOKOU
 */
public class IncrementalMFSBaseRelaxationStrategyTest extends InitTest {
	...
	RelaxationStrategy relaxed_query = new IncrementalMFSBaseRelaxationStrategy(conjunctiveQuery, sessionJena);
	...
	int number_check_queries = ((AbstractRelaxationStrategy)relaxed_query).number_mfs_query_executed;
	long duration_mfs_check_search = ((AbstractRelaxationStrategy)relaxed_query).duration__mfs_check_query_executed;
