 ...
 * @author Geraud FOKOU
 */
public class MFSUpdateStrategyRelaxationTest extends InitTest {
	...
	MFSUpdateRelaxationStrategy relaxed_query = new MFSUpdateRelaxationStrategy(conjunctiveQuery, sessionJena);
