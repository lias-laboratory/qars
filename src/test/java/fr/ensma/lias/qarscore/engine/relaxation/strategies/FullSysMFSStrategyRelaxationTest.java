 ...
 * @author Geraud FOKOU
 */
public class FullSysMFSStrategyRelaxationTest extends InitTest {
	...
	SYSFULLMFSRelaxationStrategy relaxed_query = new SYSFULLMFSRelaxationStrategy(conjunctiveQuery, sessionJena);
